...
def init_parser(alg):
    ...
    if alg == 'WOLP_DDPG':
        ...
        parser.add_argument('--action_emb_dim', default=64, type=int, help='Action embedding dimension')
        parser.add_argument('--state_emb_dim', default=64, type=int, help='Embedding dimension for state representation in attention')
