...
def init_parser(alg):
    ...
    if alg == 'WOLP_DDPG':
        ...
        parser.add_argument('--max-episode', type=int, default=2, help='maximum #episode.')
        ...
        parser.add_argument('--epsilon', default=15000, type=int, help='Linear decay of exploration policy')
