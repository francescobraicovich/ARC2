...
def init_parser(alg):
    ...
    if alg == 'WOLP_DDPG':
        ...
        parser.add_argument('--num_experiments_filter', default=600, type=int, help='number of problems on which to calculate the change percentage when filtering actions')
        parser.add_argument('--filter_threshold', default=0.6, type=float, help='percentage of random problems an action must change not to be filtered')
