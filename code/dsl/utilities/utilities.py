...
def plot_geometries(array, geometries):
    ...
    for idx, geometry in enumerate(geometries):
        axs[idx].imshow(geometry, cmap='inferno')
...
def select_by_color(array, color):
    "Return a mask with the elements of the array with the specified color."
...
def select_by_color_and_adjacent(array, target_color, display=False):
    ...
    print('Selected geometries type: ', type(selected_geometries))
    print('Selected geometries shape: ', selected_geometries.shape)
    ...
    if display:
        plot_geometries(array, selected_geometries)
    return selected_geometries
